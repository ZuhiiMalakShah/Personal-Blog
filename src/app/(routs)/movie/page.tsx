...
import img from "@/app/images/movie-app.png";
            ...
            alt="hero"
                    ...
                    <div className="text-center lg:w-2/3 w-full">
                        ...
                        <p className="text-2xl font-bold text-black">Check :</p> 
                            <Link href="https://movie-app-eight-opal.vercel.app/" target="_blank" rel="noopener noreferrer">
                                <SiVercel className="text-black text-3xl hover:text-gray-600 bg-gray-100 p-2 rounded-md transition-colors" />
                            </Link>
                            <Link href="https://github.com/SikandarTahir23/Movie-App" target="_blank" rel="noopener noreferrer">
