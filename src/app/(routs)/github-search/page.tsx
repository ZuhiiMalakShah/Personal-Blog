...
import img from "@/app/images/Github-profile.png";
            ...
            alt="Screenshot of the GitHub Profile Search Application"
                    ...
                    <div className="text-center lg:w-2/3 w-full">
                        ...
                        <p className="text-2xl font-bold text-black">Check:</p> 
                            <Link href="https://search-git-hub-profile.vercel.app/" target="_blank" rel="noopener noreferrer">
                            ...
                            <Link href="https://github.com/SikandarTahir23/Search-GitHub-Profile" target="_blank" rel="noopener noreferrer">
