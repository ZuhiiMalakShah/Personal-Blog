...
import img from "@/app/images/portfolio.png";
            ...
            alt="hero"
                    ...
                    <div className="text-center lg:w-2/3 w-full">
                        ...
                        <p className="text-2xl font-bold text-black">Check :</p>
                            <Link href="https://sikandar-folio.vercel.app/" target="_blank" rel="noopener noreferrer">
                            ...
                            <Link href="https://github.com/SikandarTahir23/Porto" target="_blank" rel="noopener noreferrer">
