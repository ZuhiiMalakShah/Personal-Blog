...
export const metadata: Metadata = {
  title: "Create Aliya Manzooor",
  description: "With the help by create next app",
};
        ...
        <header className="bg-[#0B192C] text-white body-font">
          <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center space-x-8">
              ...
              <a
                href="https://github.com/ZuhiiMalakShah"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-gray-400"
              >
              ...
              <a
                href="https://mail.google.com/mail/?view=cm&fs=1&to=sultansalahuddin295@gmail.com
                className="hover:text-gray-400"
              >
